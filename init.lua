...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettier', -- Match VSCode formatting for JS/TS and web files
      })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua' },
        -- Prettier for JS/TS and web files (match VSCode default formatter)
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        preset = 'enter', -- Enter to accept selected completion (VSCode-style)
